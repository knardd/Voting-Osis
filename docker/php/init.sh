...
echo "Menunggu container MySQL siap diproses..."
until php -r "
    try {
...
"; do
    echo "MySQL belum siap, menunggu 3 detik lagi..."
    sleep 3
done
echo "MySQL sudah siap dan menerima koneksi!"
...
if [ -f /var/www/html/database/seeders/DatabaseSeeder.php ]; then
    ...
    php artisan db:seed --force || echo "Seeder di-skip atau belum ada isi data."
fi
...
# Jalankan Nginx agar container tetap aktif
exec php-fpm