    ...
    <div class="bg-blue-50 p-4 rounded-lg mb-6">
        ...
        <div class="flex items-center gap-3">
            ...
            <button
                ...
                class="px-4 py-2 bg-blue-600 text-white font-medium rounded-md hover:bg-blue-700 transition duration-200 flex items-center justify-center gap-2"
            >
            ...
            <span wire:loading wire:target="generateUsers" class="flex items-center gap-2">
                <svg aria-hidden="true" class="w-4 h-4 text-neutral-tertiary animate-spin fill-brand shrink-0" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
